...
public:
  void set_position(
    double latitude, double longitude, double hae_ = 9999999.0, double ce_ = 9999999.0,
    double le_ = 9999999.0
  )
  {
    lat = latitude;
    lon = longitude;
  ...
  void set_parent_infotmation(
    const std::string & uid, const std::string & callsign, const std::string & type = "a-f-G"
  )
  {
    parent_uid = uid;
